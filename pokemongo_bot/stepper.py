...
class Stepper(object):
    ...
    def take_step(self):
        ...
        for step in range(self.steplimit2):
            # starting at 0 index
            logger.log('[#] Scan area dari object ({} / {})'.format(
    ...
    def _walk_to(self, speed, lat, lng, alt):
        ...
        logger.log('[#] Berjalan dari ' + str((i2f(self.api._position_lat), i2f(
            self.api._position_lng))) + " ke " + str(str((lat, lng))) +
